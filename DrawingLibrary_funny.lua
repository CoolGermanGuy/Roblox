...
Drawing1.Radius = 150
--                             |        X       |       Y            |
Drawing1.Position = Vector2.new(0.85 * (VPS.X / 2),  1.55 * (VPS.Y / 2))
...
Drawing2.Radius = 150
--                             |        X       |       Y            |
Drawing2.Position = Vector2.new(1.15 * (VPS.X / 2),  1.55 * (VPS.Y / 2))
...
Drawing4.Radius = 150
--                             |        X       |       Y            |
Drawing4.Position = Vector2.new(VPS.X / 2,  0.55 * (VPS.Y / 2))
